...
const Footer = () => {
  ...
  return (
    ...
    <div className="space-y-4">
       <h2 className="text-3xl font-bold bg-white bg-clip-text text-transparent">DEMO APP</h2>
    </div>
    <div className="space-y-4">
   ...
   Account    </h3>
          ...
          {accountLinks.map((item) => (
              <li key={item.label}>
                  <Link
          href={item.href}                className="text-white transition-colors duration-200 flex items-center group"
            >
